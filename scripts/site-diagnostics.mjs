...
const currentVersionCode = 10043;
const officialQuantUrl = "https://ceyi.yucebot.com";
const currentApk = `${officialQuantUrl}/downloads/ceyi-quant-1.0.43-10043-release.apk`;
...
assert.equal(release.sha256, "1c935d8914181baa2bd2e141e59ede054cb2ad3a4913197a30656c73ccde414e", "official-site APK sha must match verified APK");
